...
### 安装usb驱动
连接好开发板以后，先**按住** R818-DshanPI-ROSx 开发板 烧录模式按键 也称为**②FEL** 烧写模式按键，之后**按一下** 系统复位按键 也称 **①RESET** 复位键，就可以自动进入烧写模式。

![image-20241216174452925](images/image-20241216174452925.png)
